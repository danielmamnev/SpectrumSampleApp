...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SpectrumSampleApp.Android.dll" comes first in this list. */
		"SpectrumSampleApp.Android.dll",
		"FormsViewGroup.dll",
		...
		"SpectrumSampleApp.Core.dll",
		"SpectrumSampleApp.UI.dll",
